	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath}/DinnerTableServlet?method=findAllDinnerTables">餐桌管理</a>
				</li>
                <li class="level2 level2Style"> <!-- /FoodTypeServlet?method=listFoodType -->
                	<a target="right" href="${pageContext.request.contextPath}/FoodTypeServlet?method=listFoodType">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/FoodTypeServlet?method=foodtype">菜品管理</a>
				</li>
                <li class="level2 level2Style">
