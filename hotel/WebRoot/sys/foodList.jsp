...
<div id="TitleArea">
	...
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath}/FoodTypeServlet?method=findFoodTypeByName" method="post">		     
			<input type="text" name="typeName" placeholder="请输入菜系">	
...
<div id="MainArea">
                   ...
                   <c:forEach var="food" items="${requestScope.foodlist}">
                    <tr class="TableDetail1">
						...
						<c:forEach var="foodtype" items="${requestScope.foodType}">					
								<c:if test="${food.foodType_id==foodtype.id}">
   ...
   <!-- 其他功能超链接 -->
	<div id="TableTail" align="center">
		<div class="FunctionButton"><a href="${pageContext.request.contextPath}/FoodTypeServlet?method=findAllFoodType">添加</a></div>
    </div> 
</div>
</body>
